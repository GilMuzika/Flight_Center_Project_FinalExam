  ...
  public class Flight : PocoBase, IPoco
   {
       ...
       public Flight( Int64 aIRLINECOMPANY_ID, Int64 oRIGIN_COUNTRY_CODE, Int64 dESTINATION_COUNTRY_CODE, DateTime dEPARTURE_TIME, DateTime lANDING_TIME, Int32 rEMAINING_TICKETS)
       {
